...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.SourceRules();
  });
  ...
  describe('SourceRules', function() {
    it('should create an instance of SourceRules', function() {
      // uncomment below and update the code to test SourceRules
      //var instance = new Manticoresearch.SourceRules();
      //expect(instance).to.be.a(Manticoresearch.SourceRules);
    });
