...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.AggDateHistogram();
  });
  ...
  describe('AggDateHistogram', function() {
    it('should create an instance of AggDateHistogram', function() {
      // uncomment below and update the code to test AggDateHistogram
      //var instance = new Manticoresearch.AggDateHistogram();
      //expect(instance).to.be.a(Manticoresearch.AggDateHistogram);
    });
