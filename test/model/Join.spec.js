...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.Join();
  });
  ...
  describe('Join', function() {
    it('should create an instance of Join', function() {
      // uncomment below and update the code to test Join
      //var instance = new Manticoresearch.Join();
      //expect(instance).to.be.a(Manticoresearch.Join);
    });
