...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new Manticoresearch.KnnQueryByVector();
  });
  ...
  describe('KnnQueryByVector', function() {
    it('should create an instance of KnnQueryByVector', function() {
      // uncomment below and update the code to test KnnQueryByVector
      //var instance = new Manticoresearch.KnnQueryByVector();
      //expect(instance).to.be.a(Manticoresearch.KnnQueryByVector);
    });
