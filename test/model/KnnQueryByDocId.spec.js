...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new Manticoresearch.KnnQueryByDocId();
  });
  ...
  describe('KnnQueryByDocId', function() {
    it('should create an instance of KnnQueryByDocId', function() {
      // uncomment below and update the code to test KnnQueryByDocId
      //var instance = new Manticoresearch.KnnQueryByDocId();
      //expect(instance).to.be.a(Manticoresearch.KnnQueryByDocId);
    });
