...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.KnnQuery();
  });
  ...
  describe('KnnQuery', function() {
    it('should create an instance of KnnQuery', function() {
      // uncomment below and update the code to test KnnQuery
